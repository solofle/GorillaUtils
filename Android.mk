...
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -I'D:/il2cpp/libil2cpp' -isystem 'extern' -I'extern/monkecodegen/include' -DID='"GorillaUtils"' -DVERSION='"0.1.2"' -I'./shared' -I'./extern' -Wno-inaccessible-base
